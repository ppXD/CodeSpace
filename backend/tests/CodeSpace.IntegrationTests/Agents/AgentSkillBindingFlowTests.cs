...
public class AgentSkillBindingFlowTests
{
    ...
    private async Task<(Guid TeamId, Guid UserId)> SeedTeamAsync()
    {
        ...
        db.Team.Add(new Team { Id = teamId, Slug = $"skill-team-{teamId:N}", Name = "Skill Test Team", Kind = TeamKind.Workspace, CreatedBy = SystemUsers.SeederId, LastModifiedBy = SystemUsers.SeederId });
