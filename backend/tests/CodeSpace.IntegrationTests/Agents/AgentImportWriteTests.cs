...
public class AgentImportWriteTests
{
    ...
    private async Task<(Guid TeamId, Guid UserId)> SeedTeamAsync()
    {
        ...
        db.Team.Add(new Team { Id = teamId, Slug = $"imp-team-{teamId:N}", Name = "Import Team", Kind = TeamKind.Workspace, CreatedBy = SystemUsers.SeederId, LastModifiedBy = SystemUsers.SeederId });
