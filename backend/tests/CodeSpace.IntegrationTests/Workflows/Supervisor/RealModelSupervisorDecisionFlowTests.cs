...
public sealed class RealModelSupervisorDecisionFlowTests
{
    ...
    public async Task The_real_model_makes_the_right_decision_at_every_golden_point(string provider)
    {
        ...
        await RealModelGate.AssessLiveAsync(provider, async () =>
        {
            ...
            var decider = new LlmSupervisorDecider(RealModelLiveWire.Registry(), RealModelLiveWire.Selector(model, credential), new CodeSpace.Core.Services.Agents.AgentHarnessRegistry(System.Array.Empty<CodeSpace.Core.Services.Agents.IAgentHarness>()));
