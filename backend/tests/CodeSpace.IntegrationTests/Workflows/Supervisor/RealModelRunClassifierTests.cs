...
public sealed class RealModelRunClassifierTests
{
    ...
    [InlineData("model_credential_lease_lost", "API Error: 503 upstream unavailable", false)]           // ditto for the run WE ended because its brokered lease died with its worker — a restart of ours is never weather, however the tail reads
