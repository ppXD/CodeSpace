...
public class SupervisorBoundsServiceTests
{
    ...
    public async Task A_spawns_policy_parks_the_spawn_for_a_human_instead_of_creating_agents()
    {
        ...
        var service = new SupervisorTurnService(ledger, new AlwaysSpawnDecider(), executor, db: null!, new FakeAcceptanceGrader(), new FakeDecisionQueue(), new FakeDecisionArbiter(), new FakeDecisionAnswerService(), NullLogger<SupervisorTurnService>.Instance);
    ...
    private SupervisorTurnService Service(FakeSupervisorDecisionLog ledger, ISupervisorDecider decider) =>
        new(ledger, decider, new CountingExecutor(), db: null!, new FakeAcceptanceGrader(), new FakeDecisionQueue(), new FakeDecisionArbiter(), new FakeDecisionAnswerService(), NullLogger<SupervisorTurnService>.Instance);
