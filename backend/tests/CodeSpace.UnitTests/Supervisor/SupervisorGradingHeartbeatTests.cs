...
public class SupervisorGradingHeartbeatTests
{
    ...
    private static SupervisorTurnService Service(IRunRecordLogger logger) =>
        new(null!, null!, null!, db: null!, null!, null!, null!, null!, null!, logger, null!, null!, null!, new NullCompletionComposer(), null!, null!, NullLogger<SupervisorTurnService>.Instance);
