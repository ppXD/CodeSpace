...
public sealed class WorkflowRunDataCompletenessSchemaTests
{
    ...
    public void Only_the_seven_producers_two_bounded_operator_readers_and_the_reconciler_touch_either_table()
    {
        ...
        mentions.ShouldBe(new[]
        {
            ...
            // Producers that WRITE a gap and read neither table. Each sits on a path that deliberately swallows a
            // loss and settles anyway -- the engine because the node's side effect already fired, the node
