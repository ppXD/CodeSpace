...
public sealed class AgentRunExecutorPushTests
{
    ...
    private static (Guid RunId, AgentRunExecutor Executor, StubRuns Runs) NewExecutor(long epoch)
    {
        ...
        var executor = new AgentRunExecutor(runs, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, null!, new FakeCaptureIntentService(), guards, NullLogger<AgentRunExecutor>.Instance);
    ...
    private sealed class StubRuns : IAgentRunService
    {
        ...
        public Task<bool> StampSessionTranscriptCheckpointAsync(AgentRunOwnerToken owner, SessionTranscriptCheckpoint checkpoint, string? sessionId, CancellationToken cancellationToken) => Task.FromResult(true);
