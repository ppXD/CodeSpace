...
public class RerunBranchBodyPolicyTests
{
    ...
    [InlineData(true, false, true, NodeKind.Regular, false)]    // agent.code: CanSuspend + opted-in + NOT side-effecting → ADMIT (re-stage, no gate)
    [InlineData(true, false, false, NodeKind.Regular, true)]    // un-opted suspendable (wait_* / subworkflow / supervisor / sleep) → REFUSE
