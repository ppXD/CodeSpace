...
public class NodeManifestContractTests
{
    ...
    {
        var nodes = new INodeRuntime[] { new GitFetchPrDiffNode(null!), new GitFetchPrChecksNode(null!), new GitListPullRequestsNode(null!), new GitOpenPullRequestNode(null!), new GitPostPrCommentNode(null!), new GitPrReviewNode(null!) };
