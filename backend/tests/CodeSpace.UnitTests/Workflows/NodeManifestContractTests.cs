...
public class NodeManifestContractTests
{
    ...
    {
        var nodes = new INodeRuntime[] { new GitFetchPrDiffNode(null!), new GitFetchPrChecksNode(null!), new GitListPullRequestsNode(null!), new GitOpenPullRequestNode(null!), new GitMergePullRequestNode(null!), new GitCreateIssueNode(null!), new GitCommentIssueNode(null!), new GitCloseIssueNode(null!), new GitPostPrCommentNode(null!), new GitPrReviewNode(null!) };
    ...
    {
        var nodes = new INodeRuntime[] { new GitFetchPrDiffNode(null!), new GitFetchPrChecksNode(null!), new GitPostPrCommentNode(null!), new GitPrReviewNode(null!), new GitMergePullRequestNode(null!), new GitCommentIssueNode(null!), new GitCloseIssueNode(null!) };
        foreach (var node in nodes)
        {
