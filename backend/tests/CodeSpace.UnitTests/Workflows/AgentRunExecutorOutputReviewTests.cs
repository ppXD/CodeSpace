...
public sealed class AgentRunExecutorOutputReviewTests
{
    ...
    private sealed class NoopRecordLogger : IRunRecordLogger
    {
        ...
        public Task ExternalCallFailedAsync(Guid runId, string? nodeId, Guid correlationId, string target, string error, TimeSpan duration, string? category, CancellationToken ct) => Task.CompletedTask;
