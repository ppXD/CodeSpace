...
public sealed class AgentRunExecutorOutputReviewTests
{
    ...
    private static (Guid RunId, AgentRunExecutor Executor, StubRuns Runs, RecordingCritic Critic) NewExecutor(CriticVerdict verdict, Guid? pendingDecision = null, CriticVerdict? agentVerdict = null)
    {
        ...
        var executor = new AgentRunExecutor(runs, null!, null!, null!, null!, null!, null!, null!, scopeFactory, null!, critic, null!, null!, null!, null!, NullLogger<AgentRunExecutor>.Instance);
