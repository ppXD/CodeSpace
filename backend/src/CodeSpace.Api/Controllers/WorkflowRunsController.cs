...
///
/// The legacy <c>api/tasks</c> launch + phases routes are kept as deprecated absolute-route aliases on the
/// canonical actions for a non-breaking migration; a follow-up removes them once clients have cut over.
/// </summary>
[ApiController]
...
public class WorkflowRunsController : ControllerBase
{
    ...
    [HttpGet("/api/tasks/{runId:guid}/phases")]
