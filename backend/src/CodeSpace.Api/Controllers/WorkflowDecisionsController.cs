...
/// vets membership before the handler runs (<c>IRequireTeamMembership</c>). The legacy <c>api/decisions</c> routes
/// are kept as deprecated absolute-route aliases on the canonical actions for a non-breaking migration.
/// </summary>
[ApiController]
...
public class WorkflowDecisionsController : ControllerBase
{
    ...
    [HttpPost("/api/decisions/{decisionId:guid}/answer")]
