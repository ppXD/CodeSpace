...
/// <summary>
/// Thrown by <see cref="MissingProjectRefValidator"/> when a workflow definition references a
...
/// values. The validator throws this exception so the run lands in <c>Failed</c> with a
