        ...
        ConfigSchema = SchemaBuilder.Parse("""
            {
              ...
              "properties": {
                ...
                "reviewMode": { "x-group": "Review", "type": "integer", "enum": [0, 1, 2], "default": 0, "title": "Review the plan", "x-enumLabels": { "0": "Off", "1": "Gate", "2": "Improve" }, "description": "An independent reviewer over the produced plan. Gate flags concerns onto the plan's risks; Improve makes one bounded revision against the critique." },
