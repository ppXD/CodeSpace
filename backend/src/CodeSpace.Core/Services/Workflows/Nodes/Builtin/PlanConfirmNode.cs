        ...
        ConfigSchema = SchemaBuilder.Parse("""
            {
              "type": "object",
              "properties": {
                "plannerModelId": { "type": "string", "format": "uuid", "x-selector": "credentialedModel", "description": "The credentialed model REVISIONS reason on (mirrors plan.author). Leave empty to auto-pick." },
