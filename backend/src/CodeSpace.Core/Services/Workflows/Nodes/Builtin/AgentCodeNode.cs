        ...
        ConfigSchema = SchemaBuilder.Parse("""
            {
              ...
              "properties": {
                ...
                "harness":        { "type": "string", "x-selector": "harness", "description": "Agent harness kind, e.g. \"codex-cli\" — the wire protocol the run speaks. Pick from the engine's registered harnesses." },
