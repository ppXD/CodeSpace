        ...
        ConfigSchema = SchemaBuilder.Parse("""
            {
              ...
              "properties": {
                ...
                "allowedAgents": { "x-group": "Guardrails", "type": "array", "items": { "type": "string" }, "x-advanced": true, "description": "Reserved — harness/agent kinds the supervisor may spawn. Stored; enforcement is a follow-up." },
