        ...
        ConfigSchema = SchemaBuilder.Parse("""
            {
              ...
              "properties": {
                ...
                "allowedAgents": { "x-group": "Guardrails", "type": "array", "items": { "type": "string" }, "x-advanced": true, "description": "Effective harness kinds the supervisor may spawn (for example codex-cli or claude-code). Enforced after persona/model reconciliation; empty = all registered harnesses." },
