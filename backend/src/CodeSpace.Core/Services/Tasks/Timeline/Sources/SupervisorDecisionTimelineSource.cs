...
/// <summary>
/// The SUPERVISOR-LEDGER timeline source — it reuses <see cref="ISupervisorDecisionObservationBundle.GetForRunAsync"/> (team-scoped,
...
public sealed class SupervisorDecisionTimelineSource : IRunTimelineSource, IScopedDependency
{
    ...
    public SupervisorDecisionTimelineSource(ISupervisorDecisionObservationBundle observations) { _observations = observations; }
