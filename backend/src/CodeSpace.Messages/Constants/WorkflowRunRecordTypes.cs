...
public static class WorkflowRunRecordTypes
{
    ...
    /// <summary>External call threw (network error, non-2xx with retry-exhausted, etc). Payload: {"target":"...","error":"...","duration_ms":N,"category":"…"|null} — category is the transport's <c>LlmErrorCategory</c> name when the throw was a classified LLM transport fault, else null.</summary>
