...
/// <summary>The shared wire input for preview and launch. Both handlers map every control identically; a preview records intent without granting execution authority.</summary>
public abstract record TaskLaunchInput
{
    ...
    /// <summary>An optional recipe pin, shared by preview and launch.</summary>
