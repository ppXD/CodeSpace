 ...
 * bounces to `/teams/{slug}/repositories`. We can't do this in `beforeLoad`
 * because the team list lives in React Query / /me, not in synchronous storage;
 * a component-level redirect waits for the /me payload and then routes.
 *
 ...
 * landing URL settles to `/teams/{active-slug}/repositories`.
 */
