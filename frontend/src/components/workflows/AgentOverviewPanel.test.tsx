...
const run = (over: Partial<WorkflowRunSummary> = {}): WorkflowRunSummary => ({
  id: "run-aaaa1111", runNumber: 1, workflowId: "w1", workflowVersion: 3, workflowName: null, sessionTitle: null, repositoryIds: [], runKind: "workflow", wasSuspended: false, parked: false, sourceType: "manual",
