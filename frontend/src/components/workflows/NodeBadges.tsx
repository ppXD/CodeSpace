 ...
 * shows full word pills, and the palette row renders a smaller calm per-kind-tinted tag on the type-key line
 * (with a `title` tooltip), so the compact palette stays legible and one height per row.
 *
