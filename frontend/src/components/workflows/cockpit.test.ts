...
function run(id: string, status: WorkflowRunStatus, createdDate = "2026-06-22T00:00:00Z"): WorkflowRunSummary {
  return { id, runNumber: 1, workflowId: "w", workflowVersion: 1, workflowName: null, sessionTitle: null, sourceType: "manual", status, error: null, startedAt: null, completedAt: null, createdDate, rootRunId: id, attemptCount: 1, rootSourceType: "manual", hasSession: true };
}
