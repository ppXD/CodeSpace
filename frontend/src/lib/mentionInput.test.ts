...
const member = (userId: string, name: string, email = `${name.toLowerCase()}@x`): TeamMemberSummary => ({ userId, name, email, avatarUrl: null, isBot: false, role: "Member" as const, joinedAt: null });
